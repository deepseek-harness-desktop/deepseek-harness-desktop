...
import { TauriApiClient } from './tauri-api-client.ts'
...
export { TauriApiClient, type TauriIpcBridge } from './tauri-api-client.ts'
...
export function apply(ctx: Context): void {
  ...
  const api: IApiClient = fixtureClient
    ?? (globalThis.__DSH_TAURI_IPC__ === undefined ? new WebApiClient() : new TauriApiClient())
  ...
  const handle: ConnectionHandle = {
    api,
    isLoopback: globalThis.__DSH_TAURI_IPC__ !== undefined
